...
import { getSearchBaseCurrencyValue, SearchBaseCurrencyActions } from '@/entities/searchCurrency';
...
export const CurrencyBaseMenu = memo(({ currencyList, isCurMenu }: CurrencyMenuProps) => {
